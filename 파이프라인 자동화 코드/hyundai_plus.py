...
def run_crawling_for_day(day):
    ...
    #driver.get("https://www.hmall.com/pd/dpl/brodPordPbdv?mainDispSeq=2")  # 현대홈쇼핑의 크롤링 대상 URL
    ...
    # TV+샵 버튼 클릭
    wait = WebDriverWait(driver, 10)
    tv_plus_shop_button = wait.until(EC.element_to_be_clickable((By.XPATH, "//li/a[text()='TV+샵']")))
    tv_plus_shop_button.click()
